...
const HomeScreen = () => {
  ...
  const values = [
    {
      id: 1,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home1.jpg',
    ...
    {
      id: 2,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home2.jpg',
    ...
    {
      id: 3,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home3.jpg',
    ...
    {
      id: 4,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home4.jpg',
    ...
    {
      id: 5,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home5.jpg',
    ...
    {
      id: 6,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home6.jpg',
    ...
    {
      id: 7,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home7.jpg',
    ...
    {
      id: 8,
      image: 'https://arpf.org/wp-content/uploads/2023/05/icon-home8.jpg',
  ...
  const renderArpImage = ({ item }: { item: { id: number; image: any } }) => {
    return (
      ...
      <Image
        source={item.image}
        style={{ width: windowWidth, height: (windowWidth / 16) * 9, resizeMode: 'stretch' }}
      />
    );
  };
  ...
  const renderArpfImage = ({ item }: { item: { id: number; image: any } }) => {
    return (
      ...
      <Image
        source={item.image}
        style={{ width: windowWidth, height: (windowWidth / 16) * 10, resizeMode: 'stretch' }}
      />
    );
  };
      ...
      <ScrollView className="w-full">
        ...
        <View className="items-center justify-evenly bg-white w-full p-4">
          <Text className="text-center  text-black text-lg mb-4">
            The <Text className="font-bold">American River Parkway Foundation (ARPF)</Text> is a
            Sacramento 501(c)(3) nonprofit charitable organization whose mission is to lead and
            inspire the community to conserve and nurture the American River Parkway as a unique,
            accessible resource for everyone to enjoy. Our headquarters is located in the William B.
            Pond Recreation Area on the American River Parkway.
          </Text>
          <Text className="text-center  text-black text-lg mb-4">
            <Text className="font-bold">The ARPF vision</Text> is for the American River Parkway,
            which spans 23 miles and 4,800 acres, to be one of the nation's premier urban natural
            parks.
          </Text>
          <Text className="text-center font-bold text-black text-lg mb-4">
            We encourage you to contact the American River Parkway Foundation and take an active and
            personal role in contributing to the success of the Parkway.
          </Text>
          ...
          <Text className=" text-black text-lg mb-1">William B. Pond</Text>
          <View style={{ height: (windowWidth / 16) * 10, width: windowWidth }}>
            <Carousel
              data={wbpImages}
          ...
          <Text className="text-center font-bold text-black text-lg mb-4">
            The ARPF aims to accomplish its mission by exercising the following values.
          </Text>
        ...
        <View className="items-center justify-evenly bg-white w-full p-4">
          <Text className="text-center  text-black text-lg mb-4">
            Call the ARPF at (916) 486-2773. Our phones are answered Monday to Friday 8:30 AM to
            4:30 PM (Pacific Time) by friendly, local and knowledgeable people who are dedicated to
          ...
          <Text className="text-center  text-black text-lg mb-4">
            ...
            <Text
              ...
              onPress={() =>
                Linking.openURL(
                  'mailto:https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=info@arpf.org'
                )
              }>
              send a email
            </Text>{' '}
            ...
            to complete the online information request. You may also visit us during our hours of
            operation at;
          </Text>
          <Text className="font-bold w-32 text-center">5700 Arden Way Carmichael, CA 95608</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
