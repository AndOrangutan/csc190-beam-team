      ...
      <ScrollView style={styles.container}>
        ...
        <View>
          <Text style={{ fontSize: 12, marginBottom: 10, fontWeight: 'bold' }}>
            Parks & Features of the Parkway
          </Text>

          <Text>
            The American River Parkway has over a dozen access points. These access points feature
            areas to fish, swim, kayak, or run, as well as paint, relax, or watch a sunset. The
            paved Jedediah Smith Memorial Trail runs the length of the Parkway and beyond while a
            separate multi-use dirt trail meanders near the bike trail from Discovery Park to Nimbus
            Fish Hatchery and into the Folsom Lake SRA. Various parks on the Parkway and different
            amenities are listed below.
            <Text> </Text>
            To find accommodations near the American River Parkway, visit{' '}
            <Text
              style={{ color: 'blue', textDecorationLine: 'underline' }}
              onPress={() =>
                Linking.openURL('https://www.hotelscombined.com/Place/American_River_Parkway.htm')
              }>
              HotelsCombined
            </Text>
          </Text>
        ...
        <View>
          ...
          <Text>
            ...
            Includes Parkway access points and seven additional Regional Parks. Passes are valid for
            a 12-month period from month purchased.
            <Text
              style={{ color: 'blue', textDecorationLine: 'underline' }}
              onPress={() => Linking.openURL('https://arpf.org/?product_cat=parks-passes')}>
              More information
            </Text>
          </Text>
        </View>
        ...
        <View>
          ...
          <Text>
            ...
            <Text>
              {' '}
              of a park or trail on the American River Parkway for closures or construction. To
              contact a{' '}
            </Text>
            <Text
              style={{ color: 'blue', textDecorationLine: 'underline' }}
              onPress={() =>
                Linking.openURL(
                  'https://regionalparks.saccounty.gov/Rangers/Pages/RangerStewardship.aspx'
                )
              }>
              Sacramento County Parks Ranger
            </Text>
        ...
        <View style={{ flexDirection: 'row', flex: 1 }}>
          ...
          <View style={{ flex: 1, paddingHorizontal: 10 }}>
            ...
            <Text style={styles.bulletPoint}>
              • Picnic areas for reservations w/ BBQs & hot coal pits
            </Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', flex: 1 }}>
          ...
          <View style={{ flex: 1, paddingHorizontal: 10 }}>
            ...
            <Text style={styles.bulletPoint}>• Bike trail access</Text>
            <Text style={styles.bulletPoint}>
              • Water trail – popular put-in spot for rafters and kayakers
            </Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', flex: 1 }}>
          ...
          <View style={{ flex: 1, paddingHorizontal: 10 }}>
            ...
            <Text
              ...
              onPress={() =>
                Linking.openURL(
                  'https://regionalparks.saccounty.gov/Parks/PublishingImages/Pilot%20Map%20with%20Title.PNG'
                )
              }>
              Trial Map
            </Text>
        ...
        <View style={{ flexDirection: 'row', flex: 1 }}>
          ...
          <View style={{ flex: 1, paddingHorizontal: 10 }}>
            ...
            <Text style={styles.bulletPoint}>• Picnic areas</Text>
            <Text style={styles.bulletPoint}>
              • Water trail – popular take-out spot for rafters and kayakers
            </Text>
          </View>
        </View>
        ...
        <Text style={styles.headerTitle}> Discovery Park</Text>
        <View>
          <YoutubePlayer height={200} play={true} videoId="GbYhv0wx41M" />
        </View>
        ...
        <Text style={styles.headerTitle}> William B. Pond</Text>
        <View>
          <YoutubePlayer height={200} play={true} videoId="6zmm0ZeJiGU" />
        </View>
        ...
        <Text style={styles.headerTitle}>River Bend Park</Text>
        <View>
          <YoutubePlayer height={200} play={true} videoId="b782bpNVXS4" />
        </View>
        ...
        <View>
          <YoutubePlayer height={200} play={true} videoId="5R6sj9_OFHc" />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
